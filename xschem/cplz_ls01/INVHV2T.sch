...
C {sg13cmos5l_pr/sg13_hv_pmos.sym} 200 200 0 0 {name=MP model=sg13_hv_pmos w=6.0u l=0.45u ng=1 m=1 spiceprefix=X}
...
C {sg13cmos5l_pr/sg13_hv_nmos.sym} 540 200 0 0 {name=MN model=sg13_hv_nmos w=3.0u l=0.45u ng=1 m=1 spiceprefix=X}
