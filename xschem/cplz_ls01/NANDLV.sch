...
C {sg13cmos5l_pr/sg13_lv_nmos.sym} 880 200 0 0 {name=MN1 model=sg13_lv_nmos w=0.8u l=0.13u ng=1 m=1 spiceprefix=X}
...
C {sg13cmos5l_pr/sg13_lv_nmos.sym} 1220 200 0 0 {name=MN2 model=sg13_lv_nmos w=0.8u l=0.13u ng=1 m=1 spiceprefix=X}
