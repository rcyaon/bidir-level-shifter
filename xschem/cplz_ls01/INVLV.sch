...
C {sg13cmos5l_pr/sg13_lv_pmos.sym} 200 200 0 0 {name=MP model=sg13_lv_pmos w=1.0u l=0.13u ng=1 m=1 spiceprefix=X}
...
C {sg13cmos5l_pr/sg13_lv_nmos.sym} 540 200 0 0 {name=MN model=sg13_lv_nmos w=0.5u l=0.13u ng=1 m=1 spiceprefix=X}
