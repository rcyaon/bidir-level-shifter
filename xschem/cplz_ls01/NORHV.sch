...
C {sg13cmos5l_pr/sg13_hv_pmos.sym} 200 200 0 0 {name=MP1 model=sg13_hv_pmos w=4.0u l=0.45u ng=1 m=1 spiceprefix=X}
...
C {sg13cmos5l_pr/sg13_hv_pmos.sym} 540 200 0 0 {name=MP2 model=sg13_hv_pmos w=4.0u l=0.45u ng=1 m=1 spiceprefix=X}
...
C {sg13cmos5l_pr/sg13_hv_nmos.sym} 880 200 0 0 {name=MN1 model=sg13_hv_nmos w=1.0u l=0.45u ng=1 m=1 spiceprefix=X}
...
C {sg13cmos5l_pr/sg13_hv_nmos.sym} 1220 200 0 0 {name=MN2 model=sg13_hv_nmos w=1.0u l=0.45u ng=1 m=1 spiceprefix=X}
