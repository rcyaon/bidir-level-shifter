...
C {sg13cmos5l_pr/sg13_hv_pmos.sym} 200 200 0 0 {name=MP1 model=sg13_hv_pmos w=2.0u l=0.45u ng=1 m=1 spiceprefix=X}
...
C {sg13cmos5l_pr/sg13_hv_pmos.sym} 540 200 0 0 {name=MP2 model=sg13_hv_pmos w=2.0u l=0.45u ng=1 m=1 spiceprefix=X}
...
C {sg13cmos5l_pr/sg13_hv_nmos.sym} 880 200 0 0 {name=MN1 model=sg13_hv_nmos w=2.0u l=0.45u ng=1 m=1 spiceprefix=X}
...
C {devices/lab_pin.sym} 900 230 0 0 {name=l11 sig_type=std_logic lab=n1}
C {devices/lab_pin.sym} 900 200 0 0 {name=l12 sig_type=std_logic lab=vss}
C {sg13cmos5l_pr/sg13_hv_nmos.sym} 1220 200 0 0 {name=MN2 model=sg13_hv_nmos w=2.0u l=0.45u ng=1 m=1 spiceprefix=X}
C {devices/lab_pin.sym} 1240 170 0 0 {name=l13 sig_type=std_logic lab=n1}
